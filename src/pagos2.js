...
import data from './data/dataos2s.json'

let PageSize = 9;

export default function Pagos2() {
  ...
  return (
    <>
          <div className="container p-5 mx-auto">
              <Link to="/osm" className="position-relative align-self-center">
                          <CgArrowLeftO size="2em" color='red' /> <p>Go Back</p></Link>
              <h2 className="bg-danger text-light text-center">Season 2 Kurulus Osman</h2>
